...
| Evidence | Content |
|---|---|
| `evidence/headline-metrics.json` | active API performance, CPU comparison, long-form ratio |
...
| `evidence/install-validation.json` | fresh install, idempotent rerun, smoke |
| `../runner/config/model-assets.json` | size/SHA-256 of 11 release assets |
| `decisions/CHUNK32.md` | Part 0 decision |
